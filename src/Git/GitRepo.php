...
class GitRepo
{
     ...
     * @throws Exception
     */
    public function setRepoPath( string $repo_path, bool $create_new = false, bool $_init = true )
    {
        if ( is_string( $repo_path ) ) {
     ...
     * @throws Exception
     */
    public function run( string $command, array $parameters = null ): string
    {
     ...
     * @throws Exception
     */
    public function status( $html = false ): string
    {
        $msg = $this->run( "status" );
        if ( $html == true ) {
            $msg = str_replace( "\n", "<br />", $msg );
     ...
     * @throws Exception
     */
    public function cloneFrom( string $source, string $commandString = "" ): string
    {
     ...
     * @throws Exception
     */
    public function branchNew( string $branch ): string
    {
     ...
     * @throws Exception
     */
    public function branches( string $mode = GitRepo::BRANCH_LIST_MODE_LOCAL, bool $keepAsterisk = false ): array
    {
     ...
     * @return array
     */
    protected function decorateLocalBranches( array $branches, $keepAsterisk ): array
    {
     ...
     * @return array
     */
    protected function decorateRemoteBranches( array $branches ): array
    {
     ...
     * @throws Exception
     */
    public function getActiveBranch( bool $keep_asterisk = false ): string
    {
     ...
     * @throws Exception
     */
    public function push( string $remote, string $branch, bool $force = false ): string
    {
     ...
     * @throws Exception
     */
    public function diff( string $params = '' )
    {
     ...
     * @return string
     */
    public function getRemoteBranchesByPattern( string $pattern )
    {
        try {
